...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
  ...
  public long userRegister(String userAccount, String userPassword, String checkPassword) {
    ...
    HttpResponse httpResponse =
            HttpRequest.post("http://localhost:8123" + "/api/crawler/checkStudent")
                    .body(json)
                    .execute();
   ...
   */
  @Override
  public BaseResponse<String> newUserRegister(String userAccount, String userPassword)
          throws IOException {
    // 1. 校验
    ...
    Long id = user.getId();
    CompletableFuture.runAsync(() -> createUserInterfaceInfo(id), executor)
            .exceptionally(
                    ex -> {
